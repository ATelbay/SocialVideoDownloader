...
class PlayBillingRepositoryTest {
    ...
    @Test
    fun `restorePurchases returns FREE when no purchase found`() = runTest {
        val repo = createTestRepo()
    ...
    @Test
    fun `restorePurchases returns PAID when cloud_history_10k purchase is acknowledged`() = runTest {
        val repo = createTestRepo()
    ...
    @Test
    fun `restorePurchases returns FREE when purchase is not acknowledged`() = runTest {
        val repo = createTestRepo()
    ...
    @Test
    fun `restorePurchasesFromList with empty list simulates refund returns FREE`() = runTest {
        val repo = createTestRepo()
