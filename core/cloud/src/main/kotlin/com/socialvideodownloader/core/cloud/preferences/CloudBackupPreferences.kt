...
class CloudBackupPreferences
    ...
    constructor(
        ...
        override fun observeLastSyncTimestamp(): Flow<Long> = context.dataStore.data.map { prefs -> prefs[Keys.LAST_SYNC_TIMESTAMP] ?: 0L }

        override suspend fun hasEverEnabled(): Boolean = context.dataStore.data.first()[Keys.HAS_EVER_ENABLED] ?: false
