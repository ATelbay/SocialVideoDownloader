...
class VideoExtractorRepositoryImpl @Inject constructor(
    private val mapper: VideoInfoMapper,
    @IoDispatcher private val ioDispatcher: CoroutineDispatcher,
    @ApplicationContext private val context: Context,
) : VideoExtractorRepository {

    override suspend fun extractInfo(url: String): VideoMetadata = withContext(ioDispatcher) {
    ...
    override suspend fun download(
        ...
        val formatString = if (request.isVideoOnly) {
