...
// SVD Warm Editorial Palette — unified from Android ExtendedColors + iOS Colors.swift
val SvdBg = Color(0xFFF6F3EC)
val SvdSurface = Color(0xFFFFFFFF)
...
val SvdPrimaryGradientStart = Color(0xFFF26B3A)
val SvdPrimaryGradientEnd = Color(0xFFF2B84B)
...
val SvdBorder = Color(0xFFE0DDD6)
val SvdBorderStrong = Color(0xFFB6AA97)
val SvdSuccess = Color(0xFF2E7D32)
...
val SvdColorScheme =
    lightColorScheme(
        ...
        onBackground = SvdOnSurface,
        onSurface = SvdOnSurface,
        onSurfaceVariant = SvdOnSurfaceVariant,
...
// Extended colors beyond M3 color scheme
@Immutable
...
val SvdExtendedColors =
    ExtendedColors(
        ...
        primaryGradientStart = SvdPrimaryGradientStart,
        primaryGradientEnd = SvdPrimaryGradientEnd,
        warning = SvdWarning,
        accent = SvdAccent,
